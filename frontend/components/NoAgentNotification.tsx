...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  const timeToWaitMs = 20_000; // Aumentar el tiempo de espera para conexiones inestables
  ...
  return (
    <>
      {showNotification ? (
        <div className="fixed text-sm left-1/2 max-w-[90vw] -translate-x-1/2 flex top-6 items-center gap-4 bg-muted border border-border px-4 py-3 rounded-lg shadow-lg z-50">
          <div>
            {/* Warning Icon */}
            <svg
              width="24"
          ...
          <p className="text-pretty w-max text-foreground">
            El <strong>Asistente Virtual de Cajicá</strong> se está conectando...<br/>
          ...
          <a
            ...
            target="_blank"
            className="underline whitespace-nowrap text-primary hover:text-primary/80"
          >
            Documentación
          </a>
          <button 
